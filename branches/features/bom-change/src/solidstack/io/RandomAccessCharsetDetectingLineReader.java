 ...
 */
public class RandomAccessCharsetDetectingLineReader implements RandomAccessLineReader
{
	private Resource resource;
	private LineReader reader;
	private String encodingOverride;

	public RandomAccessCharsetDetectingLineReader( Resource resource ) throws FileNotFoundException
	{
		// TODO Check that the resource is reopenable
		this.resource = resource;
		this.reader = new CharsetDetectingLineReader( resource );
	}
	...
	protected void reOpen()
	{
		...
		try
		{
			this.reader = new CharsetDetectingLineReader( this.resource, this.encodingOverride );
		}
