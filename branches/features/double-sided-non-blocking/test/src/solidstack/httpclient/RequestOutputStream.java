...
public class RequestOutputStream extends OutputStream
{
	...
	public RequestOutputStream( Request request, OutputStream out )
	{
...
//				System.out.write( b, off, len );
			...
			{
				this.request.writeHeader( this.out );
...
//				System.out.write( this.buffer, 0, this.pos );
	...
	public void clear()
	{
		Assert.isFalse( this.request.isCommitted() );
		this.pos = 0;
	}
}
