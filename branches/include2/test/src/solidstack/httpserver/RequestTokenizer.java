...
public class RequestTokenizer
{
	...
	public Token getNewline()
	{
		...
		// Check newline
		if( ch == -1 )
			throw new SourceException( "Unexpected end of statement", this.in.getLocation() );
		if( ch != '\n' )
			throw new SourceException( "Expecting end of line, not [" + (char)ch + "]", this.in.getLocation() );
